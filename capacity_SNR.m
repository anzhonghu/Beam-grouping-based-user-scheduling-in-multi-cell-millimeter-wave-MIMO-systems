...
P = 4;
K = 20;
variable_s = [1e6; 1e7; 1e8; 1e9;1e10;  1e11;]*1e7;
height = 10;
...
for variable_n = 1 : length(variable_s)
    Pvsigma2 = variable_s(variable_n, 1);
    for ii = 1 : Nite
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
variable_ss = 10 * log10(variable_s*1e-14);%%%-140dBË¥ÂäÎªµäÐÍÖµ
h1 = subplot(1,2,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(variable_ss, capacity(1:length(variable_ss), 1), 'k--s','LineWidth',1,'MarkerSize',10)
hold on
plot(variable_ss, capacity(1:length(variable_ss), 2), 'k--*','LineWidth',1,'MarkerSize',10)
plot(variable_ss, capacity(1:length(variable_ss), 3), 'k--o','LineWidth',1,'MarkerSize',12)
plot(variable_ss, capacity(1:length(variable_ss), 4), 'k-^','LineWidth',1,'MarkerSize',10)
...
%%%%%%%%%%%%%%%%%%%%%%%%
h2 = subplot(1,2,2);
plot(variable_ss, jain(1:length(variable_ss), 1), 'k--s','LineWidth',1,'MarkerSize',10)
hold on
plot(variable_ss, jain(1:length(variable_ss), 2), 'k--*','LineWidth',1,'MarkerSize',10)
plot(variable_ss, jain(1:length(variable_ss), 3), 'k--o','LineWidth',1,'MarkerSize',12)
plot(variable_ss, jain(1:length(variable_ss), 4), 'k-^','LineWidth',1,'MarkerSize',10)
xlim([min(variable_ss), max(variable_ss)])
set(le,'Fontname','Times')
set(gca,'XTick',variable_ss)
xlabel('SNR (dB)','Fontname','Times')
